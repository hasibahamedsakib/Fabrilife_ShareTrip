    ...
    <div className="mt-4 flex justify-between items-center ">
      {!isInCart ? (
        <button
          ...
          } text-white px-4 py-2  shadow flex items-center justify-center gap-2 text-sm rounded-md transition-all duration-300 border-[1.5px] border-white/30 hover:border-success`}
        ...
        <div
          className={`w-[150px] sm:w-[185px] h-8 mx-auto flex items-center justify-between gap-1 sm:gap-2  ${
            isModal
              ? "bg-success"
              : "bg-white/30 backdrop-blur-md hover:bg-success"
        ...
        >
          ...
          <button className=" px-1 sm:px-2 py-1 " onClick={handleAddToCart}>
            <FiPlus size={16} />
          </button>
        </div>
      )}
